    ...
    <>
      <div className="px-4 md:px-16 lg:px-24 xl:px-32">
        {loading ? (
                  ...
                  <div className="p-4 text-white bg-gradient-to-t from-transparent group-hover:from-violet-950 to-transparent transition-colors">
                    ...
                    >
                      ...
                      <div className="flex gap-3 text-white text-sm">
                        ...
                        <Link to={`/view/${project.id}`} target="_blank" className='px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md transition-colors'>Open</Link>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex justify-center items-center h-[800px] text-gray-400">
